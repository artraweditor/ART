                        ...
                        true)
{
    ...
    radius =
        Gtk::manage(new Adjuster(M("TP_DEFRINGE_RADIUS"), 0.5, 5.0, 0.1, 2.0));
    threshold =
        Gtk::manage(new Adjuster(M("TP_DEFRINGE_THRESHOLD"), 0, 100, 1, 13));
...
{
    // WARNING: The following line won't work, since linear is a flat curve at
    // 0.
