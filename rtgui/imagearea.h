...
public:
    ...
    ImageArea
        *iLinkedImageArea; // used to set a reference to the Before image area,
    ...
    void setScrollPosition(int x, int y); // called by the imageareapanel when
                                          // the scrollbars have been changed
