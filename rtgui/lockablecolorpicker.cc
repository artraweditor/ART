...
LockableColorPicker::LockableColorPicker(CropWindow *cropWindow,
                                         Glib::ustring *oProfile,
                                         Glib::ustring *wProfile)
    : cropWindow(cropWindow), displayedValues(ColorPickerType::RGB),
      position(0, 0), size(Size::S15), outputProfile(oProfile),
      workingProfile(wProfile), validity(Validity::OUTSIDE), r(0.f), g(0.f),
      b(0.f), rpreview(0.f), gpreview(0.f), bpreview(0.f), l(0.f), c(0.f),
      h(0.f), L(0.f), a(0.f), bb(0.f)
{
}
...
void LockableColorPicker::updateBackBuffer()
{
    ...
    if (validity == Validity::INSIDE) {
        ...
        fontd.set_size(
            (options.CPFontFamily == "default" ? 8 : options.CPFontSize) *
            Pango::SCALE);
        ...
        PointerMotionListener *navigator =
            cropWindow->getPointerMotionListener();

        switch (displayedValues) {
        case ColorPickerType::RGB:
            navigator->getRGBText((int)(r * 255.f), (int)(g * 255.f),
                                  (int)(b * 255.f), s1, s2, s3);
...
LockableColorPicker::Size LockableColorPicker::getSize() { return size; }
