 ...
 * - if you add more than one curve, you must add a "CurveEditor* ce" parameter
 * to your listener
 */
...
public:
    ...
    void updateEditButton(CurveEditor *curve, Gtk::ToggleButton *button,
    ...
    virtual void pipetteMouseOver(EditDataProvider *provider,
                                  int modifierKey) = 0;
    ...
    virtual bool
    curveReset(CurveEditor *ce) = 0; // Reset a curve editor, return TRUE if
...
protected:
    ...
    virtual void storeCurveValues(CurveEditor *ce,
