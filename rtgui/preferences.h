...
class Preferences: public Gtk::Dialog, public ProfileStoreListener {
    ...
    Options moptions;
    sigc::connection tconn, sconn, fconn, cpfconn, addc, setc, dfconn, ffconn,
        bpconn, rpconn, ipconn;
    ...
    void parseDir(Glib::ustring dirname, std::vector<Glib::ustring> &items,
                  Glib::ustring ext);
...
public:
    ...
    static void switchThemeTo(const Glib::ustring &newTheme,
