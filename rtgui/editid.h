...
enum EditType {
    ET_PIPETTE, /// Will trigger dedicated methods; can have a geometry list to
                /// be displayed, but without "mouse over" capabilities
    ET_OBJECTS  /// The objects are geometrical widgets with "mouse over"
                /// capabilities
};
