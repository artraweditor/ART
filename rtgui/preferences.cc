...
// GTK318
    ...
    about->signal_clicked().connect(
        sigc::mem_fun(*this, &Preferences::aboutPressed));
    ok->signal_clicked().connect(sigc::mem_fun(*this, &Preferences::okPressed));
    cancel->signal_clicked().connect(
        sigc::mem_fun(*this, &Preferences::cancelPressed));
    ...
    nb->append_page(*getDynamicProfilePanel(),
                    M("PREFERENCES_TAB_DYNAMICPROFILE"));
...
Gtk::Widget *Preferences::getImageProcessingPanel()
{
    ...
    Gtk::Frame *fpp =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_IMPROCPARAMS")));
    ...
    Gtk::Label *drimg = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_FORIMAGE") + ":", Gtk::ALIGN_START));
    iprofiles = Gtk::manage(new ProfileStoreComboBox());
    iprofiles->addRow(dynpse);
    iprofiles->set_size_request(50, -1);
    setExpandAlignProperties(iprofiles, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);
    ...
    defpt->attach(*rprofiles, 1, 2, 0, 1, Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK,
                  Gtk::SHRINK, 2, 2);
    defpt->attach(*drimg, 0, 1, 1, 2, Gtk::FILL, Gtk::SHRINK, 2, 2);
    defpt->attach(*iprofiles, 1, 2, 1, 2, Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK,
                  Gtk::SHRINK, 2, 2);
    ...
    Gtk::Frame *cpfrm =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_CUSTPROFBUILD")));
    Gtk::Label *cplab = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_CUSTPROFBUILDPATH") + ":", Gtk::ALIGN_START));
    txtCustProfBuilderPath = Gtk::manage(new Gtk::Entry());
    txtCustProfBuilderPath->set_tooltip_markup(
        M("PREFERENCES_CUSTPROFBUILDHINT"));
    ...
    custProfBuilderLabelType->append(
        M("PREFERENCES_CUSTPROFBUILDKEYFORMAT_TID"));
    custProfBuilderLabelType->append(
        M("PREFERENCES_CUSTPROFBUILDKEYFORMAT_NAME"));
    custProfBuilderLabelType->append(
        M("PREFERENCES_CUSTPROFBUILDKEYFORMAT_TID") + "_" +
        M("PREFERENCES_CUSTPROFBUILDKEYFORMAT_NAME"));
    Gtk::Table *cpbt = Gtk::manage(new Gtk::Table(2, 2));
    cpbt->attach(*cplab, 0, 1, 0, 1, Gtk::FILL, Gtk::SHRINK, 2, 2);
    cpbt->attach(*txtCustProfBuilderPath, 1, 2, 0, 1,
                 Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK, Gtk::SHRINK, 2, 2);
    cpbt->attach(*cpltypelab, 0, 1, 1, 2, Gtk::FILL, Gtk::SHRINK, 2, 2);
    cpbt->attach(*custProfBuilderLabelType, 1, 2, 1, 2,
                 Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK, Gtk::SHRINK, 2, 2);
    cpfrm->add(*cpbt);
    vbImageProcessing->pack_start(*cpfrm, Gtk::PACK_SHRINK, 4);

    Gtk::Frame *fdp =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_PROFILEHANDLING")));
    ...
    Gtk::Label *splab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_PROFILESAVELOCATION") + ":"));
    setExpandAlignProperties(splab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    vbdp->attach(*splab, 0, 1, 0, 1, Gtk::FILL, Gtk::SHRINK, 2, 2);
    vbdp->attach(*saveParamsPreference, 1, 2, 0, 1,
                 Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK, Gtk::SHRINK, 2, 2);
    Gtk::Label *lplab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_PROFILELOADPR") + ":"));
    ...
    setExpandAlignProperties(lplab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    vbdp->attach(*loadParamsPreference, 1, 2, 1, 2,
                 Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK, Gtk::SHRINK, 2, 2);

    lplab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_PROFILE_SAVE_OUTPUT") + ":"));
    saveOutParamsPreference = Gtk::manage(new Gtk::ComboBoxText());
    saveOutParamsPreference->append(
        M("PREFERENCES_PROFILE_SAVE_OUTPUT_SIDECAR"));
    saveOutParamsPreference->append(
        M("PREFERENCES_PROFILE_SAVE_OUTPUT_EMBEDDED"));
    vbdp->attach(*lplab, 0, 1, 2, 3, Gtk::FILL, Gtk::SHRINK, 2, 2);
    setExpandAlignProperties(lplab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    vbdp->attach(*saveOutParamsPreference, 1, 2, 2, 3,
                 Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK, Gtk::SHRINK, 2, 2);

    lplab = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_PARAMS_SIDECAR_STYLE") + ":"));
    ...
    paramsSidecarStripExtension->append(
        M("PREFERENCES_PARAMS_SIDECAR_STRIP_EXT"));
    vbdp->attach(*lplab, 0, 1, 3, 4, Gtk::FILL, Gtk::SHRINK, 2, 2);
    setExpandAlignProperties(lplab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    vbdp->attach(*paramsSidecarStripExtension, 1, 2, 3, 4,
                 Gtk::EXPAND | Gtk::FILL | Gtk::SHRINK, Gtk::SHRINK, 2, 2);
    ...
    setExpandAlignProperties(mtbl, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(mlbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    mlbl =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_XMP_SIDECAR_MODE") + ": "));
    ...
    exiftoolPath->set_tooltip_text(M("PREFERENCES_EXIFTOOL_PATH_TOOLTIP"));
    {
        ...
        show_exiftool_makernotes = Gtk::manage(
            new Gtk::CheckButton(M("PREFERENCES_SHOW_EXIFTOOL_MAKERNOTES")));
        hb->pack_start(*show_exiftool_makernotes, Gtk::PACK_SHRINK, 4);
    }
    setExpandAlignProperties(mlbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    setExpandAlignProperties(exiftoolPath, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(dirgrid, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);

    Gtk::Label *dfLab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_DIRDARKFRAMES") + ":"));
    setExpandAlignProperties(dfLab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    darkFrameDir = Gtk::manage(
        new MyFileChooserButton(M("PREFERENCES_DIRDARKFRAMES"),
                                Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
    setExpandAlignProperties(darkFrameDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    dfLabel = Gtk::manage(new Gtk::Label("Found:"));
    setExpandAlignProperties(dfLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(ffLab, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    flatFieldDir = Gtk::manage(
        new MyFileChooserButton(M("PREFERENCES_FLATFIELDSDIR"),
                                Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
    setExpandAlignProperties(flatFieldDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ffLabel = Gtk::manage(new Gtk::Label("Found:"));
    setExpandAlignProperties(ffLabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(clutsDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *clutsRestartNeeded = Gtk::manage(new Gtk::Label(
    ...
    dirgrid->attach_next_to(*clutsRestartNeeded, *clutsDir, Gtk::POS_RIGHT, 1,
                            1);
    ...
    Gtk::Frame *owf =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_BATCH_PROCESSING")));
    ...
    autosaveInterval->set_increments(1, 1);
    {
        ...
        auto lbl =
            Gtk::manage(new Gtk::Label(M("PREFERENCES_AUTOSAVE_INTERVAL")));
        ...
        hb2->pack_start(*Gtk::manage(new Gtk::Label(
...
Gtk::Widget *Preferences::getPerformancePanel()
{
    ...
    Gtk::Label *lprevdemo = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_PREVIEW_RESAMPLING_QUALITY")));
    ...
    hbprevdemo = Gtk::manage(new Gtk::HBox(false, 4));
    hbprevdemo->pack_start(
        *Gtk::manage(new Gtk::Label(M("PREFERENCES_WBPREVIEW_LABEL"))),
        Gtk::PACK_SHRINK);
    ...
    denoiseZoomedOut =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_DENOISE_ZOOM_OUT")));
    denoiseZoomedOut->set_tooltip_text(
        M("PREFERENCES_DENOISE_ZOOM_OUT_TOOLTIP"));
    vb->pack_start(*denoiseZoomedOut);
    ctl_scripts_fast_preview_ = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_CTL_SCRIPTS_FAST_PREVIEW")));
#ifdef ART_USE_CTL
    ...
    ctiffserialize = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_SERIALIZE_TIFF_READ_LABEL")));
    ctiffserialize->set_tooltip_text(
        M("PREFERENCES_SERIALIZE_TIFF_READ_TOOLTIP"));
    ...
    Gtk::Frame *fclut =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_CLUTSCACHE")));
    Gtk::HBox *clutCacheSizeHB = Gtk::manage(new Gtk::HBox());
    clutCacheSizeHB->set_spacing(4);
    Gtk::Label *CLUTLl = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_CLUTSCACHE_LABEL") + ":", Gtk::ALIGN_START));
    ...
    Gtk::Frame *finspect =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_INSPECT_LABEL")));
    Gtk::HBox *maxIBuffersHB = Gtk::manage(new Gtk::HBox());
    maxIBuffersHB->set_spacing(4);
    maxIBuffersHB->set_tooltip_text(
        M("PREFERENCES_INSPECT_MAXBUFFERS_TOOLTIP"));
    Gtk::Label *maxIBufferLbl = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_INSPECT_MAXBUFFERS_LABEL") + ":", Gtk::ALIGN_START));
    ...
    maxInspectorBuffersSB->set_range(
        1, 12); // ... we have to set a limit, 12 seem to be enough even for
                // systems with tons of RAM
    ...
    Gtk::Label *threadsLbl = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_PERFORMANCE_THREADS_LABEL") + ":", Gtk::ALIGN_START));
    ...
    threadsLbl = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_PERFORMANCE_THREADS_THUMB_UPDATE") +
                           " (" + M("PREFERENCES_APPLNEXTSTARTUP") + ")" + ":",
                       Gtk::ALIGN_START));
    ...
    Gtk::Frame *thumbFrame =
        Gtk::manage(new Gtk::Frame(M("MAIN_FRAME_FILEBROWSER")));
    thumbDelayUpdate = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_THUMBNAIL_DELAY_UPDATE")));
    thumbLazyCaching = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_THUMBNAIL_LAZY_CACHING")));
    thumb_cache_processed_ = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_THUMBNAIL_CACHE_PROCESSED")));
    {
        Gtk::VBox *vb = Gtk::manage(new Gtk::VBox());
    ...
    Gtk::Frame *fe_frame =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_TAB_FASTEXPORT")));
    {
        Gtk::HBox *hbox = Gtk::manage(new Gtk::HBox());
        fastexport_max_width = Gtk::manage(new MySpinButton());
        fastexport_max_height = Gtk::manage(new MySpinButton());
        hbox->pack_start(*Gtk::manage(new Gtk::Label(M("EXPORT_MAXWIDTH"))),
                         Gtk::PACK_SHRINK, 4);
...
Gtk::Widget *Preferences::getColorManPanel()
{
    ...
    setExpandAlignProperties(iccDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *pdlabel = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_ICCDIR") + ":", Gtk::ALIGN_START));
    setExpandAlignProperties(pdlabel, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);

    Gtk::Grid *iccdgrid = Gtk::manage(new Gtk::Grid());
    setExpandAlignProperties(iccdgrid, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);
    iccdgrid->set_column_spacing(4);

    Gtk::Label *monProfileRestartNeeded = Gtk::manage(new Gtk::Label(
        Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(monProfileRestartNeeded, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    ...
    // iccDir->signal_selection_changed ().connect (sigc::mem_fun (this,
    // &Preferences::iccDirChanged));

    vbColorMan->pack_start(*iccdgrid, Gtk::PACK_SHRINK);

    monitorIccDir = Gtk::manage(
        new MyFileChooserButton(M("PREFERENCES_MONITORICCDIR"),
                                Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
    setExpandAlignProperties(monitorIccDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    pdlabel = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_MONITORICCDIR") + ":", Gtk::ALIGN_START));
    setExpandAlignProperties(pdlabel, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    monProfileRestartNeeded = Gtk::manage(new Gtk::Label(
        Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(monProfileRestartNeeded, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    ...
    Gtk::Frame *fmonitor =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_MONITOR")));
    Gtk::Grid *gmonitor = Gtk::manage(new Gtk::Grid());
    gmonitor->set_column_spacing(4);

    monProfile = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(monProfile, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *mplabel = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_MONPROFILE") + ":", Gtk::ALIGN_START));
    setExpandAlignProperties(mplabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);

    monIntent = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(monIntent, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *milabel = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_MONINTENT") + ":", Gtk::ALIGN_START));
    ...
    setExpandAlignProperties(monBPC, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    if (rtengine::Settings::color_mgmt_mode !=
        ...
        if (rtengine::Settings::color_mgmt_mode ==
            ...
            auto rst = Gtk::manage(new Gtk::Label(
                Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
            setExpandAlignProperties(rst, false, false, Gtk::ALIGN_START,
                                     Gtk::ALIGN_BASELINE);
            gmonitor->attach(*rst, 2, row, 1, 1);
            ++row;
            auto infolbl = Gtk::manage(new Gtk::Label(
                M("PREFERENCES_OSCOLORMGMT_INFO"), Gtk::ALIGN_START));
    ...
    Gtk::Frame *fprinter =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_PRINTER")));
    Gtk::Grid *gprinter = Gtk::manage(new Gtk::Grid());
    gprinter->set_column_spacing(4);
    prtProfile = Gtk::manage(new MyFileChooserButton(
        M("PREFERENCES_PRTPROFILE"), Gtk::FILE_CHOOSER_ACTION_OPEN));
    {
    ...
    setExpandAlignProperties(prtProfile, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *pplabel =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_PRTPROFILE") + ":"));
    setExpandAlignProperties(pplabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);

    prtIntent = Gtk::manage(new Gtk::ComboBoxText());
    setExpandAlignProperties(prtIntent, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *pilabel =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_PRTINTENT") + ":"));
    setExpandAlignProperties(pilabel, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(prtBPC, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
...
Gtk::Widget *Preferences::getGeneralPanel()
{
    ...
    Gtk::Frame *fworklflow =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_WORKFLOW")));
    setExpandAlignProperties(fworklflow, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    Gtk::Label *lNextStart = Gtk::manage(new Gtk::Label(
        Glib::ustring("(") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(lNextStart, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*flayoutlab, Gtk::POS_LEFT, 1, 1);
    workflowGrid->attach_next_to(*editorLayout, *flayoutlab, Gtk::POS_RIGHT, 1,
                                 1);
    workflowGrid->attach_next_to(*lNextStart, *editorLayout, Gtk::POS_RIGHT, 1,
                                 1);
    ...
    Gtk::Label *curveBBoxPosRestartL = Gtk::manage(new Gtk::Label(
        Glib::ustring("(") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(curveBBoxPosRestartL, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*curveBBoxPosL, *flayoutlab, Gtk::POS_BOTTOM,
                                 1, 1);
    workflowGrid->attach_next_to(*curveBBoxPosC, *editorLayout, Gtk::POS_BOTTOM,
                                 1, 1);
    workflowGrid->attach_next_to(*curveBBoxPosRestartL, *lNextStart,
                                 Gtk::POS_BOTTOM, 1, 1);

    ckbHistogramPositionLeft = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_HISTOGRAMPOSITIONLEFT")));
    setExpandAlignProperties(ckbHistogramPositionLeft, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*ckbHistogramPositionLeft, *curveBBoxPosL,
                                 Gtk::POS_BOTTOM, 1, 1);

    ckbFileBrowserToolbarSingleRow = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_FILEBROWSERTOOLBARSINGLEROW")));
    setExpandAlignProperties(ckbFileBrowserToolbarSingleRow, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_START);
    ckbShowFilmStripToolBar = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_SHOWFILMSTRIPTOOLBAR")));
    setExpandAlignProperties(ckbShowFilmStripToolBar, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_START);
    workflowGrid->attach_next_to(*ckbFileBrowserToolbarSingleRow,
                                 *ckbHistogramPositionLeft, Gtk::POS_BOTTOM, 1,
                                 1);
    workflowGrid->attach_next_to(*ckbShowFilmStripToolBar, *curveBBoxPosC,
                                 Gtk::POS_BOTTOM, 2, 1);

    adjuster_force_linear = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_ADJUSTER_FORCE_LINEAR") + " (" +
                             M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(adjuster_force_linear, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_START);
    workflowGrid->attach_next_to(*adjuster_force_linear,
                                 *ckbShowFilmStripToolBar, Gtk::POS_BOTTOM, 1,
                                 1);

    Gtk::Label *hb4label =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_TP_LABEL")));
    setExpandAlignProperties(hb4label, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    ckbHideTPVScrollbar =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_TP_VSCROLLBAR")));
    setExpandAlignProperties(ckbHideTPVScrollbar, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*hb4label, *ckbFileBrowserToolbarSingleRow,
                                 Gtk::POS_BOTTOM, 1, 1);
    Gtk::HBox *hb = Gtk::manage(new Gtk::HBox());
    hb->pack_start(*ckbHideTPVScrollbar);
    // workflowGrid->attach_next_to (*ckbHideTPVScrollbar, *hb4label,
    // Gtk::POS_RIGHT, 1, 1);
    ckbTpDisable = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_TP_DISABLE") + " (" +
                             M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    // workflowGrid->attach_next_to(*ckbTpDisable, *ckbHideTPVScrollbar,
    // Gtk::POS_RIGHT, 1, 1);
    ...
    workflowGrid->attach_next_to(*ckbAutoSaveTpOpen, *hb4label, Gtk::POS_BOTTOM,
                                 1, 1);
    btnSaveTpOpenNow =
        Gtk::manage(new Gtk::Button(M("PREFERENCES_SAVE_TP_OPEN_NOW")));
    setExpandAlignProperties(btnSaveTpOpenNow, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    workflowGrid->attach_next_to(*btnSaveTpOpenNow, *ckbAutoSaveTpOpen,
                                 Gtk::POS_RIGHT, 1, 1);
    ...
    setExpandAlignProperties(flang, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_START);
    ...
    for (size_t i = 0; i < langs.size(); i++) {
        if (/*"default" != langs[i] &&*/ "README" != langs[i] &&
            "LICENSE" != langs[i] && langs[i].size() > 0 &&
            langs[i][langs[i].size() - 1] != '~') {
            languages->append(langs[i]);
        }
    }

    Gtk::Label *langw = Gtk::manage(new Gtk::Label(
        Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    setExpandAlignProperties(langw, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    langGrid->attach_next_to(*ckbLangAutoDetect, Gtk::POS_LEFT, 3, 1);
    langGrid->attach_next_to(*langlab, *ckbLangAutoDetect, Gtk::POS_BOTTOM, 1,
                             1);
    ...
    setExpandAlignProperties(themeLbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    Gtk::Label *themeRestartLbl = Gtk::manage(new Gtk::Label(
        Glib::ustring(" (") + M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    ...
    // setExpandAlignProperties(themeCBT, true, false, Gtk::ALIGN_START,
    // Gtk::ALIGN_CENTER);
    ...
    if (options.fontFamily == "default") {
        mainFontFB->set_font_name(Glib::ustring::compose(
            "%1 %2", initialFontFamily, initialFontSize));
    } else {
        mainFontFB->set_font_name(Glib::ustring::compose(
            "%1 %2", options.fontFamily, options.fontSize));
    }

    Gtk::Label *colorPickerFontLbl = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_APPEARANCE_COLORPICKERFONT") + ":"));
    ...
    // Gtk::Label* cropMaskColorLbl = Gtk::manage(new
    // Gtk::Label(M("PREFERENCES_APPEARANCE_CROPMASKCOLOR") + ":"));
    // setExpandAlignProperties(cropMaskColorLbl, false, false,
    // Gtk::ALIGN_START, Gtk::ALIGN_CENTER);

    // cropMaskColorCB = Gtk::manage(new Gtk::ColorButton());
    // cropMaskColorCB->set_use_alpha(true);

    // Gtk::Label* navGuideColorLbl = Gtk::manage(new
    // Gtk::Label(M("PREFERENCES_APPEARANCE_NAVGUIDECOLOR") + ":"));
    // setExpandAlignProperties(navGuideColorLbl, false, false,
    // Gtk::ALIGN_START, Gtk::ALIGN_CENTER);

    // navGuideColorCB = Gtk::manage(new Gtk::ColorButton());
    // navGuideColorCB->set_use_alpha(true);

    theme_bg_lbl = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_APPEARANCE_THEME_BG_COLOR") + ":"));
    setExpandAlignProperties(theme_bg_lbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    theme_bg_color = Gtk::manage(new Gtk::ColorButton());
    theme_bg_color->set_use_alpha(false);

    theme_fg_lbl = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_APPEARANCE_THEME_FG_COLOR") + ":"));
    setExpandAlignProperties(theme_fg_lbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    theme_fg_color = Gtk::manage(new Gtk::ColorButton());
    theme_fg_color->set_use_alpha(false);

    theme_hl_lbl = Gtk::manage(
        new Gtk::Label(M("PREFERENCES_APPEARANCE_THEME_HL_COLOR") + ":"));
    setExpandAlignProperties(theme_hl_lbl, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
...

    {
        ...
        setExpandAlignProperties(hb2, true, false, Gtk::ALIGN_START,
                                 Gtk::ALIGN_BASELINE);
        ...
        reset->signal_clicked().connect(sigc::slot<void>([&]() -> void {
            Options opts;
            Gdk::RGBA c;
    ...
    // appearanceFrame->add(*appearanceGrid);
    // vbGeneral->attach_next_to(*appearanceFrame, *flang, Gtk::POS_BOTTOM, 2,
    // 1);
    abox->set_spacing(4);
    ...
    Gtk::Frame *fclip =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_CLIPPINGIND")));
    setExpandAlignProperties(fclip, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);
    Gtk::Grid *clipGrid = Gtk::manage(new Gtk::Grid());
    clipGrid->set_column_spacing(4);
    clipGrid->set_row_spacing(4);
    setExpandAlignProperties(clipGrid, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);

    Gtk::Label *hll =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_HLTHRESHOLD") + ": "));
    setExpandAlignProperties(hll, true, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    hlThresh = Gtk::manage(new Gtk::SpinButton());
    setExpandAlignProperties(hlThresh, false, false, Gtk::ALIGN_END,
                             Gtk::ALIGN_BASELINE);
    ...
    Gtk::Label *shl =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_SHTHRESHOLD") + ": "));
    setExpandAlignProperties(shl, true, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_BASELINE);
    shThresh = Gtk::manage(new Gtk::SpinButton());
    setExpandAlignProperties(shThresh, false, false, Gtk::ALIGN_END,
                             Gtk::ALIGN_BASELINE);
    shThresh->show();
    ...
    fclip->add(*clipGrid);
    // vbGeneral->attach_next_to (*fclip, *appearanceFrame, Gtk::POS_BOTTOM, 1,
    // 1);
    ...
    Gtk::Frame *fnav =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_NAVIGATIONFRAME")));
    setExpandAlignProperties(fclip, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);
    Gtk::Grid *navigationGrid = Gtk::manage(new Gtk::Grid());
    navigationGrid->set_column_spacing(4);
    navigationGrid->set_row_spacing(4);
    setExpandAlignProperties(fclip, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_FILL);

    Gtk::Label *panFactorLabel = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_PANFACTORLABEL") + ":", Gtk::ALIGN_START));
    ...
    navigationGrid->attach_next_to(*panFactor, *panFactorLabel, Gtk::POS_RIGHT,
                                   1, 1);

    rememberZoomPanCheckbutton =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_REMEMBERZOOMPAN")));
    setExpandAlignProperties(rememberZoomPanCheckbutton, false, false,
                             Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    ...
    fnav->add(*navigationGrid);
    {
        ...
        Gtk::Frame *finspector =
            Gtk::manage(new Gtk::Frame(M("PREFERENCES_INSPECT_LABEL")));
        Gtk::VBox *vb = Gtk::manage(new Gtk::VBox());
        thumbnailInspectorHover = Gtk::manage(
            new Gtk::CheckButton(M("PREFERENCES_THUMBNAIL_INSPECTOR_HOVER")));
        vb->pack_start(*thumbnailInspectorHover);
        setExpandAlignProperties(thumbnailInspectorHover, false, false,
                                 Gtk::ALIGN_START, Gtk::ALIGN_START);
        finspector->add(*vb);
    ...
    Gtk::Frame *fdg =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_EXTERNALEDITOR")));
    setExpandAlignProperties(fdg, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);
    ...
    setExpandAlignProperties(externaleditorGrid, false, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_FILL);

    edOther =
        Gtk::manage(new Gtk::RadioButton(M("PREFERENCES_EDITORCMDLINE") + ":"));
    setExpandAlignProperties(edOther, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    editorToSendTo = Gtk::manage(new Gtk::Entry());
    setExpandAlignProperties(editorToSendTo, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_BASELINE);
    Gtk::RadioButton::Group ge = edOther->get_group();

#ifdef __APPLE__
    edGimp = Gtk::manage(new Gtk::RadioButton("GIMP"));
    setExpandAlignProperties(edGimp, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    edGimp->set_group(ge);
    externaleditorGrid->attach_next_to(*edGimp, Gtk::POS_TOP, 2, 1);

    edPS = Gtk::manage(new Gtk::RadioButton("Adobe Photoshop"));
    setExpandAlignProperties(edPS, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    // psDir = Gtk::manage ( new MyFileChooserButton (M ("PREFERENCES_PSPATH"),
    // Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER) ); setExpandAlignProperties
    // (psDir, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_CENTER);
    ...
    externaleditorGrid->attach_next_to(*editorToSendTo, *edOther,
                                       Gtk::POS_RIGHT, 1, 1);
#elif defined WIN32
    edGimp = Gtk::manage(new Gtk::RadioButton(M("PREFERENCES_GIMPPATH") + ":"));
    setExpandAlignProperties(edGimp, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    gimpDir = Gtk::manage(new MyFileChooserButton(
        M("PREFERENCES_GIMPPATH"), Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
    setExpandAlignProperties(gimpDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    ...
    setExpandAlignProperties(edPS, false, false, Gtk::ALIGN_START,
                             Gtk::ALIGN_CENTER);
    psDir = Gtk::manage(new MyFileChooserButton(
        M("PREFERENCES_PSPATH"), Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER));
    setExpandAlignProperties(psDir, true, false, Gtk::ALIGN_FILL,
                             Gtk::ALIGN_CENTER);
    externaleditorGrid->attach_next_to(*edPS, *edGimp, Gtk::POS_BOTTOM, 1, 1);
    externaleditorGrid->attach_next_to(*psDir, *edPS, Gtk::POS_RIGHT, 1, 1);
    edPS->set_group(ge);
    ...
    externaleditorGrid->attach_next_to(*edOther, *edGimp, Gtk::POS_BOTTOM, 1,
                                       1);
    externaleditorGrid->attach_next_to(*editorToSendTo, *edOther,
                                       Gtk::POS_RIGHT, 1, 1);
    ...
    editor_dir_current = Gtk::manage(
        new Gtk::RadioButton(M("PREFERENCES_EXTEDITOR_DIR_CURRENT")));
    editor_dir_custom = Gtk::manage(
        new Gtk::RadioButton(M("PREFERENCES_EXTEDITOR_DIR_CUSTOM") + ": "));
    ...
    {
        Gtk::Frame *f =
            Gtk::manage(new Gtk::Frame(M("PREFERENCES_EXTEDITOR_DIR")));
        setExpandAlignProperties(f, true, false, Gtk::ALIGN_FILL,
                                 Gtk::ALIGN_FILL);
        Gtk::VBox *vb = Gtk::manage(new Gtk::VBox());
    ...
    theme_bg_color->signal_color_set().connect(
        sigc::mem_fun(*this, &Preferences::themeChanged));
    theme_fg_color->signal_color_set().connect(
        sigc::mem_fun(*this, &Preferences::themeChanged));
    theme_hl_color->signal_color_set().connect(
        sigc::mem_fun(*this, &Preferences::themeChanged));
...
Gtk::Widget *Preferences::getFileBrowserPanel()
{
    ...
    Gtk::Frame *fsd =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_STARTUPIMDIR")));
    ...
    sdother =
        Gtk::manage(new Gtk::RadioButton(M("PREFERENCES_DIROTHER") + ": "));
    ...
    sdselect->signal_clicked().connect(
        sigc::mem_fun(*this, &Preferences::selectStartupDir));

    //---

    Gtk::Frame *fro =
        Gtk::manage(new Gtk::Frame(M("PREFERENCES_FBROWSEROPTS")));
    showDateTime =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_SHOWDATETIME")));
    showBasicExif =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_SHOWBASICEXIF")));
    showExpComp = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_SHOWEXPOSURECOMPENSATION")));
    ...
    filmStripOverlayedFileNames = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_OVERLAY_FILENAMES_FILMSTRIP")));
    highlight_selected_thumbnails = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_HIGHLIGHT_SELECTED_THUMBNAILS")));
    sameThumbSize = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_FSTRIP_SAME_THUMB_HEIGHT")));
    sameThumbSize->set_tooltip_text(
        M("PREFERENCES_FSTRIP_SAME_THUMB_HEIGHT_HINT"));
    ckbInternalThumbIfUntouched = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_INTERNALTHUMBIFUNTOUCHED")));
    ...
    thumbRatingMode =
        Gtk::manage(new Gtk::CheckButton(M("PREFERENCES_THUMBNAIL_RATING")));
    remember_metadata_filters = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_REMEMBER_METADATA_FILTERS")));
    remember_rename_options = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_REMEMBER_RENAME_OPTIONS")));
    dir_browser_single_click = Gtk::manage(
        new Gtk::CheckButton(M("PREFERENCES_DIRBROWSER_SINGLECLICK") + " (" +
                             M("PREFERENCES_APPLNEXTSTARTUP") + ")"));
    ...
    Gtk::Label *labrecent =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_MAXRECENTFOLDERS") + ":"));
    ...
    // Gtk::Frame* frmnu = Gtk::manage ( new Gtk::Frame (M
    // ("PREFERENCES_MENUOPTIONS")) );

    // Gtk::Grid* menuGrid = Gtk::manage(new Gtk::Grid());
    // menuGrid->get_style_context()->add_class("grid-spacing");
    // setExpandAlignProperties(menuGrid, false, false, Gtk::ALIGN_START,
    // Gtk::ALIGN_CENTER);

    // ckbmenuGroupRank = Gtk::manage ( new Gtk::CheckButton (M
    // ("PREFERENCES_MENUGROUPRANK")) );
    // setExpandAlignProperties(ckbmenuGroupRank, false, false,
    // Gtk::ALIGN_START, Gtk::ALIGN_CENTER); ckbmenuGroupLabel = Gtk::manage (
    // new Gtk::CheckButton (M ("PREFERENCES_MENUGROUPLABEL")) );
    // ckbmenuGroupFileOperations = Gtk::manage ( new Gtk::CheckButton (M
    // ("PREFERENCES_MENUGROUPFILEOPERATIONS")) );
    // setExpandAlignProperties(ckbmenuGroupFileOperations, false, false,
    // Gtk::ALIGN_START, Gtk::ALIGN_CENTER); ckbmenuGroupProfileOperations =
    // Gtk::manage ( new Gtk::CheckButton (M
    // ("PREFERENCES_MENUGROUPPROFILEOPERATIONS")) ); ckbmenuGroupExtProg =
    ...
    Gtk::Label *elab =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_PARSEDEXTADD") + ":"));
    ...
    Gtk::Image *moveExtDownImg =
        Gtk::manage(new RTImage("arrow-down-small.svg"));
    ...
    // Separation is needed so that a button is not accidentally clicked when
    // one wanted to click a spinbox. Ideally, the separation wouldn't require
    // attaching a widget, but how?
    ...
    addExt->signal_clicked().connect(
        sigc::mem_fun(*this, &Preferences::addExtPressed));
    delExt->signal_clicked().connect(
        sigc::mem_fun(*this, &Preferences::delExtPressed));
    ...
    extension->signal_activate().connect(
        sigc::mem_fun(*this, &Preferences::addExtPressed));
...
Gtk::Widget *Preferences::getSoundsPanel()
{
    ...
    Gtk::Label *lSndHelp =
        Gtk::manage(new Gtk::Label(M("PREFERENCES_SND_HELP")));
    ...
    Gtk::Label *lSndBatchQueueDone = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_SND_BATCHQUEUEDONE") + Glib::ustring(":")));
    pBatchQueueDone->pack_start(*lSndBatchQueueDone, Gtk::PACK_SHRINK, 4);

    txtSndBatchQueueDone = Gtk::manage(new Gtk::Entry());
    pBatchQueueDone->pack_end(*txtSndBatchQueueDone, Gtk::PACK_EXPAND_WIDGET,
                              4);
    ...
    Gtk::Label *lSndLngEditProcDone = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_SND_LNGEDITPROCDONE") + Glib::ustring(":")));
    pSndLngEditProcDone->pack_start(*lSndLngEditProcDone, Gtk::PACK_SHRINK, 4);

    txtSndLngEditProcDone = Gtk::manage(new Gtk::Entry());
    pSndLngEditProcDone->pack_start(*txtSndLngEditProcDone,
                                    Gtk::PACK_EXPAND_WIDGET, 4);

    Gtk::Label *lSndLngEditProcDoneSecs = Gtk::manage(new Gtk::Label(
        M("PREFERENCES_SND_THRESHOLDSECS") + Glib::ustring(":")));
    pSndLngEditProcDone->pack_start(*lSndLngEditProcDoneSecs, Gtk::PACK_SHRINK,
                                    12);
    ...
    pSndLngEditProcDone->pack_end(*spbSndLngEditProcDoneSecs, Gtk::PACK_SHRINK,
                                  4);
...
void Preferences::parseDir(Glib::ustring dirname,
                           std::vector<Glib::ustring> &items, Glib::ustring ext)
{
    ...
    for (Glib::DirIterator i = dir->begin(); i != dir->end(); ++i) {
        ...
        if (!Glib::file_test(fname, Glib::FILE_TEST_IS_DIR) &&
            sname.size() >= ext.size() &&
            sname.substr(sname.size() - ext.size(), ext.size()).casefold() ==
                ext) {
...
void Preferences::parseThemeDir(Glib::ustring dirname)
{
    ...
    for (Glib::DirIterator i = dir->begin(); i != dir->end(); ++i) {
        ...
        if (regex->match(sname, matchInfo) &&
            !Glib::file_test(fname, Glib::FILE_TEST_IS_DIR) &&
            sname.size() >= 4) {
            bool keepIt = false;
            ...
            if (keepIt &&
                sname[0] == '_') { // filter out file names starting with _
                                   // (these are implementation files...)
                keepIt = false;
            }

            if (keepIt) {
                themeFNames.push_back(ThemeFilename(
                    matchInfo.fetch(1), sname.substr(0, sname.size() - 4),
                    deprecated));
            }
        }
    }
    ...
    std::sort(
        themeFNames.begin(), themeFNames.end(),
    ...
    if (GTK_MINOR_VERSION >= 20) {
        themeFNames.insert(themeFNames.begin(),
                           ThemeFilename(M("PROFILEPANEL_PDEFAULT"),
                                         Options::DEFAULT_THEME, false));
    }
...
void Preferences::storePreferences()
{
    ...
    // Options::DEFPROFILE_RAW & Options::DEFPROFILE_IMG profiles, because
    // useBundledProfiles may be false. We're now using
    // Options::DEFPROFILE_INTERNAL instead, which is always available.
    ...
    // ckbmenuGroupFileOperations->get_active();
    // moptions.menuGroupProfileOperations =
    // ckbmenuGroupProfileOperations->get_active(); moptions.menuGroupExtProg =
    // ckbmenuGroupExtProg->get_active();
    ...
    moptions.theme =
        themeFNames.at(themeCBT->get_active_row_number()).longFName;
...
//     moptions.psDir = psDir->get_filename ();
    ...
    moptions.editor_bypass_output_profile =
        editor_bypass_output_profile->get_active();

    moptions.CPBPath = txtCustProfBuilderPath->get_text();
    moptions.CPBKeys =
        CPBKeyType(custProfBuilderLabelType->get_active_row_number());
    ...
    moptions.wb_preview_mode =
        Options::WBPreviewMode(wbpreview->get_active_row_number());
    moptions.preview_resampling_quality = Options::PreviewResamplingQuality(
        preview_resampling_quality->get_active_row_number());
    ...
    for (size_t i = 0; i < c.size(); i++) {
        ...
        moptions.parseExtensionsEnabled.push_back(
            c[i][extensionColumns.enabled]);
    }
    ...
    moptions.filmStripOverlayedFileNames =
        filmStripOverlayedFileNames->get_active();
    moptions.highlight_selected_thumbnails =
        highlight_selected_thumbnails->get_active();
    moptions.sameThumbSize = sameThumbSize->get_active();
    moptions.internalThumbIfUntouched =
        ckbInternalThumbIfUntouched->get_active();
    ...
    moptions.params_out_embed =
        saveOutParamsPreference->get_active_row_number() == 1;
    moptions.params_sidecar_strip_extension =
        paramsSidecarStripExtension->get_active_row_number() == 1;
    ...
    moptions.histogramPosition = ckbHistogramPositionLeft->get_active()
                                     ? Options::HISTOGRAM_POS_LEFT
                                     : Options::HISTOGRAM_POS_RIGHT;
    moptions.FileBrowserToolbarSingleRow =
        ckbFileBrowserToolbarSingleRow->get_active();
...
// Sounds only on Windows and Linux
    ...
    moptions.thumbnail_rating_mode =
    ...
    moptions.remember_exif_filter_settings =
        remember_metadata_filters->get_active();
...
void Preferences::fillPreferences()
{
    ...
    // setActiveTextOrIndex (*prtProfile, moptions.rtSettings.printerProfile,
    // 0);
    {
        auto pp = moptions.rtSettings.printerProfile;
        if (pp.find("file:") == 0) {
    ...
    if (Glib::file_test(moptions.rtSettings.iccDirectory,
                        Glib::FILE_TEST_IS_DIR)) {
        iccDir->set_current_folder(moptions.rtSettings.iccDirectory);
    }

    if (Glib::file_test(moptions.rtSettings.monitorIccDirectory,
                        Glib::FILE_TEST_IS_DIR)) {
        monitorIccDir->set_current_folder(
            moptions.rtSettings.monitorIccDirectory);
    }

    cprevdemo->set_active(moptions.prevdemo);
    preview_resampling_quality->set_active(
        int(moptions.preview_resampling_quality));
    ...
    // moptions.cutOverlayBrush[1], moptions.cutOverlayBrush[2]);
    // cropMaskColorCB->set_rgba (cropCol);
    // cropMaskColorCB->set_alpha ( (unsigned short)
    // (moptions.cutOverlayBrush[3] * 65535.0));

    // Gdk::RGBA NavGuideCol;
    // NavGuideCol.set_rgba (moptions.navGuideBrush[0],
    // moptions.navGuideBrush[1], moptions.navGuideBrush[2]);
    // navGuideColorCB->set_rgba (NavGuideCol);
    // navGuideColorCB->set_alpha ( (unsigned short) (moptions.navGuideBrush[3]
    // * 65535.0));

    Gdk::RGBA bg_col;
    bg_col.set_rgba(moptions.theme_bg_color[0] / 255.0,
                    moptions.theme_bg_color[1] / 255.0,
                    moptions.theme_bg_color[2] / 255.0);
    theme_bg_color->set_rgba(bg_col);

    Gdk::RGBA fg_col;
    fg_col.set_rgba(moptions.theme_fg_color[0] / 255.0,
                    moptions.theme_fg_color[1] / 255.0,
                    moptions.theme_fg_color[2] / 255.0);
    theme_fg_color->set_rgba(fg_col);

    Gdk::RGBA hl_col;
    hl_col.set_rgba(moptions.theme_hl_color[0] / 255.0,
                    moptions.theme_hl_color[1] / 255.0,
                    moptions.theme_hl_color[2] / 255.0);
    ...
    // ckbmenuGroupFileOperations->set_active
    // (moptions.menuGroupFileOperations);
    // ckbmenuGroupProfileOperations->set_active
    // (moptions.menuGroupProfileOperations); ckbmenuGroupExtProg->set_active
    // (moptions.menuGroupExtProg);
    ...
    editor_dir_temp->set_active(moptions.editor_out_dir ==
                                Options::EDITOR_OUT_DIR_TEMP);
    ...
    if (Glib::file_test(moptions.editor_custom_out_dir,
                        Glib::FILE_TEST_IS_DIR)) {
        editor_dir_custom_path->set_current_folder(
            moptions.editor_custom_out_dir);
    } else {
        editor_dir_custom_path->set_current_folder(Glib::get_tmp_dir());
    }
    editor_float32->set_active(moptions.editor_float32);
    editor_bypass_output_profile->set_active(
        moptions.editor_bypass_output_profile);
    ...
    filmStripOverlayedFileNames->set_active(
        moptions.filmStripOverlayedFileNames);
    highlight_selected_thumbnails->set_active(
        moptions.highlight_selected_thumbnails);
    ...
    paramsSidecarStripExtension->set_active(
        moptions.params_sidecar_strip_extension ? 1 : 0);
    ...
    ckbHistogramPositionLeft->set_active(moptions.histogramPosition ==
                                         Options::HISTOGRAM_POS_LEFT);
    ckbFileBrowserToolbarSingleRow->set_active(
        moptions.FileBrowserToolbarSingleRow);
    ...
    thumbRatingMode->set_active(moptions.thumbnail_rating_mode ==
                                Options::ThumbnailRatingMode::XMP);
    ...
    remember_metadata_filters->set_active(
        moptions.remember_exif_filter_settings);
    ...
    bool theme_colors_visible =
        (GTK_MINOR_VERSION >= 20 && moptions.theme == Options::DEFAULT_THEME);
...
void Preferences::cancelPressed()
{
    ...
    if (themeFNames.at(themeCBT->get_active_row_number()).longFName !=
            options.theme ||
    ...
    if (getFontFamily(fd) != options.fontFamily &&
...
void Preferences::themeChanged()
{
    ...
    if (theme_color_visible) {
        ...
        if (options.rtSettings.verbose > 1) {
            std::cout << "switched to svg color: " << options.svg_color
                      << std::endl;
        }
    }
    RTImage::updateImages();
...
void Preferences::bundledProfilesChanged()
{
    ...
    // parseProfiles does use options.useBundledProfiles, so we temporarily
    // change its value
                                ...
                                const Options *opts)
{
    ...
    if (GTK_MINOR_VERSION >= 20 && newTheme == Options::DEFAULT_THEME) {
        ...
        const auto pth = [](std::string s) -> std::string {
#ifdef WIN32
            for (auto &c : s) {
                if (c == '\\') {
                    c = '/';
        ...
        std::string dark =
            std::string("rgb(") + std::to_string(int(bg[0] * factor)) + "," +
            std::to_string(int(bg[1] * factor)) + "," +
            std::to_string(int(bg[2] * factor)) + ")"; // "black";
        std::string filename(
            Glib::build_filename(options.ART_base_dir, "themes", "_ART.css"));
        buf << "@define-color ART-bg rgb(" << bg[0] << "," << bg[1] << ","
            << bg[2] << ");\n"
            << "@define-color ART-fg rgb(" << fg[0] << "," << fg[1] << ","
            << fg[2] << ");\n"
            << "@define-color ART-hl rgb(" << hl[0] << "," << hl[1] << ","
            << hl[2] << ");\n"
        ...
        Glib::ustring filename(Glib::build_filename(
            options.ART_base_dir, "themes", newTheme + ".css"));
...
void Preferences::workflowUpdate()
{
    ...
    if (moptions.FileBrowserToolbarSingleRow !=
        options.FileBrowserToolbarSingleRow) {
    ...
    if (moptions.rtSettings.printerProfile !=
            options.rtSettings.printerProfile ||
        ...
        parent->updateProfiles(moptions.rtSettings.printerProfile,
                               moptions.rtSettings.printerIntent,
...
void Preferences::updateDFinfos()
{
    ...
    Glib::ustring s = Glib::ustring::compose(
        ...
        M("PREFERENCES_DARKFRAMETEMPLATES"));
    dfLabel->set_text(s);
}
...
void Preferences::updateFFinfos()
{
    ...
    Glib::ustring s = Glib::ustring::compose(
        ...
        M("PREFERENCES_FLATFIELDTEMPLATES"));
    ffLabel->set_text(s);
}
