...
static gint32 load_thumbnail_image(const gchar *filename, gint thumb_size,
                                   GError **error);
...
static void init(void)
{
    ...
    if (g_spawn_sync(NULL, argv, NULL,
                     ...
                     NULL, &rawtherapee_stdout, NULL, NULL, NULL)) {
    ...
    for (i = 0; i < G_N_ELEMENTS(file_formats); i++) {
        ...
        gimp_install_procedure(
            format->load_proc, format->load_blurb, format->load_help,
            "Alberto Griggio", "Alberto Griggio", "2017", format->file_type,
                         ...
                         GError **error)
{
    ...
    gchar *argv[] = {"rawtherapee", "-gimp", (gchar *)filename, filename_out,
                     NULL};
    ...
    if (g_spawn_sync(NULL, argv, NULL,
                     ...
                     G_SPAWN_STDERR_TO_DEV_NULL | G_SPAWN_SEARCH_PATH, NULL,
                     NULL, &rawtherapee_stdout, NULL, NULL, error)) {
                                   ...
                                   GError **error)
{
    ...
    if (thumb_pp3_f &&
        ...
        image_ID =
            gimp_file_load(GIMP_RUN_NONINTERACTIVE, filename_out, filename_out);
        if (image_ID != -1) {
